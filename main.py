...
async def spin_wheel_handler(callback: CallbackQuery, session: AsyncSession, bot: Bot):
    ...
    frames = ["🎰 🍒 ▪️ ▪️", "🎰 ▪️ 🔑 ▪️", "🎰 ▪️ ▪️ 💰", "🎰 ✨ ✨ ✨"]
    # ИЗМЕНЕНО: анимация и результат колеса теперь идут в ОТДЕЛЬНОМ новом
    # сообщении, а не через edit_text прежнего сообщения — иначе стирались
    # бы выданные ключ и ссылка на файлы из сообщения о покупке.
